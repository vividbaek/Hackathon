...
import { createExecEvent, createOpenEvent, createOsEventFromPayload } from '../src/integrations/os-guard.js';
...
test('OS event payload validation rejects invalid payloads', () => {
  ...
  assert.throws(() => createOsEventFromPayload({ type: 'unlink', path: '.env' }), /Unsupported/);
});
